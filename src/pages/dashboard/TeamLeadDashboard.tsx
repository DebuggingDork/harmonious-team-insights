    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:ml-64">
        ...
        <div className="p-6">
          ...
          >
            <h1 className="text-2xl font-bold text-foreground mb-2">Team Lead Dashboard</h1>
            <p className="text-muted-foreground mb-8">Monitor your team's performance and sprint progress.</p>

            {/* Stats Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                { label: "Team Members", value: "8", change: "Active" },
                { label: "Sprint Progress", value: "67%", change: "On track" },
                { label: "Tasks Completed", value: "24/36", change: "This sprint" },
                { label: "Blockers", value: "2", change: "Need attention" },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
            ...
            <div className="bg-card border border-border rounded-xl p-8 text-center">
              ...
              <h2 className="text-lg font-semibold text-foreground mb-2">Team Lead Dashboard</h2>
              <p className="text-muted-foreground max-w-md mx-auto">
                Enable Lovable Cloud to unlock full team management features including 
                sprint boards, velocity charts, and 1:1 tracking.
              </p>
            </div>
          </motion.div>
        </div>
