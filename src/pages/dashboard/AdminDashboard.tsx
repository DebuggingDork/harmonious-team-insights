      ...
      <main className="lg:ml-64">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs text-muted-foreground">admin@teamtune.io</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="p-6">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">Manage your organization and monitor system health.</p>

            {/* Stats Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                { label: "Total Users", value: "1,234", change: "+12%" },
                { label: "Active Projects", value: "56", change: "+3" },
                { label: "System Health", value: "99.9%", change: "Optimal" },
                { label: "Pending Actions", value: "8", change: "Review" },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
            ...
            <div className="bg-card border border-border rounded-xl p-8 text-center">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                Enable Lovable Cloud to unlock full admin functionality including user management, 
